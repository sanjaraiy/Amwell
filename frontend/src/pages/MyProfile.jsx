...
<div>
  ...
  <div className='mt-10'>
    {
      isEdit 
      ? <button className='border border-[#5f6FFF] px-8 py-2 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all' onClick={updateUserProfileData}>Save</button>
